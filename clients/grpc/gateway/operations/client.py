...
class OperationsGatewayGRPCClient(GRPCClient):
    ...
    def make_fee_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией комиссии.
        """
    ...
    def make_top_up_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией пополнения.
        """
    ...
    def make_cashback_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией кэшбэка.
        """
    ...
    def make_transfer_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией перевода.
        """
    ...
    def make_purchase_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией покупки.
        """
    ...
    def make_bill_payment_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией оплаты по счету.
        """
    ...
    def make_cash_withdrawal_operation_api(
        ...
        :return: Ответ от сервиса с созданной операцией снятия наличных.
        """
    ...
    def get_operations(self, account_id: str) -> GetOperationsResponse:
        """
        Получение списка операций по ID счета.
    ...
    def make_fee_operation(
        ...
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией комиссии.
        """
        request = MakeFeeOperationRequest(
    ...
    def make_top_up_operation(
        ...
        :param card_id: Идентификатор карты.
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией пополнения.
        """
        request = MakeTopUpOperationRequest(
            status=fake.proto_enum(OperationStatus),
            amount=fake.amount(),
    ...
    def make_cashback_operation(
        ...
        :param card_id: Идентификатор карты.
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией кэшбэка.
        """
        request = MakeCashbackOperationRequest(
            status=fake.proto_enum(OperationStatus),
            amount=fake.amount(),
    ...
    def make_transfer_operation(
        ...
        :param card_id: Идентификатор карты.
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией перевода.
        """
        request = MakeTransferOperationRequest(
            status=fake.proto_enum(OperationStatus),
            amount=fake.amount(),
    ...
    def make_purchase_operation(
        ...
        :param card_id: Идентификатор карты.
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией покупки.
        """
        request = MakePurchaseOperationRequest(
            status=fake.proto_enum(OperationStatus),
            amount=fake.amount(),
    ...
    def make_bill_payment_operation(
        ...
        :param card_id: Идентификатор карты.
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией оплаты по счету.
        """
        request = MakeBillPaymentOperationRequest(
            status=fake.proto_enum(OperationStatus),
            amount=fake.amount(),
    ...
    def make_cash_withdrawal_operation(
        ...
        :param card_id: Идентификатор карты.
        :param account_id: Идентификатор счета.
        :return: Ответ с созданной операцией снятия наличных.
        """
        request = MakeCashWithdrawalOperationRequest(
            status=fake.proto_enum(OperationStatus),
            amount=fake.amount(),
