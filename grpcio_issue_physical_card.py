...
card_gateways_service = CardsGatewayServiceStub(channel)
...
open_credit_card_account_response: OpenCreditCardAccountResponse = account_gateway_service.OpenCreditCardAccount(
...
issue_physical_card_response: IssuePhysicalCardResponse = card_gateway_service.IssuePhysicalCard(
