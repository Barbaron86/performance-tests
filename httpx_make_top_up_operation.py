...
open_credit_card_account_payload_response_data = open_credit_card_account_payload_response.json()

account_id = open_credit_card_account_payload_response_data['account']['id']
card_id = open_credit_card_account_payload_response_data['account']['cards'][0]['id']
